...
export class RestApiService {
  ...
  apiUrl = 'http://localhost:8090/roomapi/';
  ...
  getBookingListByGuestId(guestId): Observable<any[]> {
    return this.http.get<any[]>(this.apiUrl + 'bookingList/'+guestId).pipe(retry(1), catchError(this.handleError));
  }
  ...
  updateReservation(bookingData): Observable<any> {
    return this.http.post<any>(this.apiUrl + 'updateReservation', bookingData).pipe(retry(1), catchError(this.handleError));
  }
